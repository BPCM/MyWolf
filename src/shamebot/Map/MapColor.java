...
public class MapColor
{
	...
	public short getR()
	{
		return (short) Math.round(color == Hue.Transparent ? color.getR() * 235 / 255F : color.getR() * brightness.getBrightnessFactor()
	...
	public short getG()
	{
		return (short) Math.round(color == Hue.Transparent ? color.getG() * 235 / 255F : color.getG() * brightness.getBrightnessFactor()
	...
	public short getB()
	{
		return (short) Math.round(color == Hue.Transparent ? color.getB() * 235 / 255F : color.getB() * brightness.getBrightnessFactor()
