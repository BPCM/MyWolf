...
public class MapPixel extends MapColor
{
	...
	public short getR()
	{
		return (short) Math.round(color == Hue.Transparent ? color.getR() * (239 - (x + y & 1) * 8) / 255F : super.getR()
	...
	public short getG()
	{
		return (short) Math.round(color == Hue.Transparent ? color.getG() * (239 - (x + y & 1) * 8) / 255F : super.getG()
	...
	public short getB()
	{
		return (short) Math.round(color == Hue.Transparent ? color.getB() * (239 - (x + y & 1) * 8) / 255F : super.getB()
